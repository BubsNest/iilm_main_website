...
const footerLinks = {
  ...
  quickLinks: [
    ...
    { label: "Life at IILM", href: "/life-at-iilm" },
    { label: "Admissions 2026", href: "/admissions" },
    { label: "Fee Portal", href: "https://admissions.iilm.edu" },
    { label: "Research & Publications", href: "/about#research" },
  ],
  alumni: [
    { label: "Lodhi Road Alumni", href: "https://alumnind.iilm.edu" },
    { label: "Gurugram Alumni", href: "https://alumniggn.iilm.edu" },
    { label: "Greater Noida Alumni", href: "https://alumnign.iilm.edu" },
  ],
};
...
const socialLinks = [
  {
    label: "Facebook",
    href: "https://facebook.com/iilminstitute",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/iilm",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "YouTube",
    href: "https://youtube.com/user/iilmhigheredu",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "Twitter / X",
    href: "https://twitter.com/IilmInstitute",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-5 flex flex-col sm:flex-row justify-between items-center gap-3">
          <p className="text-xs text-white/40">
            © {new Date().getFullYear()} IILM University. All rights reserved.
          </p>
